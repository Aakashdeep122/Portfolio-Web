...
const Projects = () => {
  return (
    <section
      id="projects"
      className="px-5 lg:px-0 py-8 lg:py-8 max-w-7xl mx-auto"
    >
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-8">
        {projects.map((project) => (
          <a
            ...
            className="group bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl
              transition-all duration-300 hover:-translate-y-3 hover:border-[#efae1e] hover:shadow-[0_0_25px_rgba(239,174,30,0.15)] "
          >
